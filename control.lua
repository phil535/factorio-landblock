...
landblock.giveresearch = function(force)
  local techs = {
    'landfill',
    'bio-paper-1'
  }
...
landblock.giveitems = function(entity)
...
script.on_event(defines.events.on_player_joined_game, function(e)
  landblock.giveresearch(game.players[e.player_index].force)
end)

script.on_event(defines.events.on_force_created, function(e)
  landblock.giveresearch(e.force)
end)
